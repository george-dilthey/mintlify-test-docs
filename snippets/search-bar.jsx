...
export const SearchBar = ({
    ...
    const iconStyles = {
        ...
        spacing: "mr-2",
        color: "bg-primary hover:bg-gray-600 dark:bg-black dark:hover:bg-white/70",
    };
    ...
    return (
        <button
            ...
            className={`${buttonClasses} bg-white dark:bg-white`}
        ...
        >
            ...
            {shortcut && (
                <span className={`hidden sm:inline-flex ${badgeStyles.text} ${badgeStyles.color} ${badgeStyles.background} ${badgeStyles.spacing} ${badgeStyles.shape} dark:bg-gray-100`}>
                    {shortcut}
                </span>
            )}
        </button>
